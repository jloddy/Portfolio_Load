...
PATH = E:\SHARED\CADA\SAS SOURCE CODE\DEVELOPMENT\JHUBBARD\EBG\1_PORTFOLIO_FILE_STANDARDIZATION\PRODUCTION ENVIRONMENT TEST\RETURN MAIL\&DATE.;

PROC EXPORT DATA=RETURN_MAIL_FILE
	OUTFILE="&PATH.\RETURN_MAIL.CSV"
	REPLACE
	DBMS=CSV;
RUN;
