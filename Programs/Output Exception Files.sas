...
PROC EXPORT DATA=BANKRUPTCY_FINAL
	OUTFILE="&EXCEPTION_PATH.\BANKRUPTCY_FINAL_EXCEPTIONS.CSV"
	DBMS=CSV
	REPLACE
	LABEL;
RUN;
...
PROC EXPORT DATA=DECEASED_FINAL
	OUTFILE="&EXCEPTION_PATH.\DECEASED_FINAL_EXCEPTIONS.CSV"
	DBMS=CSV
	REPLACE
	LABEL;
RUN;
...
PROC EXPORT DATA=LITIGIOUS_FINAL
	OUTFILE="&EXCEPTION_PATH.\LITIGIOUS_FINAL_EXCEPTIONS.CSV"
	DBMS=CSV
	REPLACE
	LABEL;
RUN;
...
PROC EXPORT DATA=MILITARY_FINAL_EXCEPTIONS
	OUTFILE="&EXCEPTION_PATH.\MILITARY_FINAL_EXCEPTIONS.CSV"
	DBMS=CSV
	REPLACE
	LABEL;
RUN;