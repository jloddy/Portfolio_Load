...
%LET SCRUB_PATH = E:\SHARED\CADA\SAS SOURCE CODE\DEVELOPMENT\JHUBBARD\EBG\1_PORTFOLIO_FILE_STANDARDIZATION\PRODUCTION ENVIRONMENT TEST\SCRUB EXPORTS\&DATE.;
...
PROC EXPORT DATA=LN_PHONE_SCRUB_BASE
	OUTFILE="&SCRUB_PATH\LN_PHONE_SCRUB.CSV"
	DBMS=CSV
	REPLACE;
RUN;
...
PROC EXPORT DATA=TLO_PHONE_SCRUB_BASE
	OUTFILE="&SCRUB_PATH\TLO_PHONE_SCRUB.CSV"
	DBMS=CSV
	REPLACE;
RUN;
